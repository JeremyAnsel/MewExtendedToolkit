...
/// <summary>
/// Low level handling of Html Renderer logic, this class is used by <see cref="HtmlLabel"/> and <see cref="HtmlPanel"/>.
/// </summary>
...
public sealed class HtmlContainer : IDisposable
{
    ...
    {
        _htmlContainerInt = new HtmlContainerInt(MewAdapter.Instance)
        {
    ...
    public void PerformPaint(IGraphicsContext g, Rect clip)
    {
    ...
    public void HandleMouseUp(Control parent, MouseEventArgs e)
    {
        ...
        ArgChecker.AssertArgNotNull(e, nameof(e));

        var mouseEvent = new RMouseEvent(e.Button == MouseButton.Left);
    ...
    /// <summary>
    /// Create HtmlRenderer key event from MewUI key event.
    /// </summary>
